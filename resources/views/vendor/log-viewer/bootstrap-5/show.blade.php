        ...
        <div class="card mb-4">
            ...
            <div class="card-header">
                <span class="badge text-bg-info float-right">
                    {{ __('Page :current of :last', ['current' => $entries->currentPage(), 'last' =>
                    $entries->lastPage()]) }}
                </span>
            </div>
            @endif
            ...
            <div class="table-responsive">
                <table id="entries" class="table mb-0">
                    <thead>
                        <tr>
                            <th style="width: 87px;">@lang('ENV')</th>
                            <th style="width: 120px;">@lang('Level')</th>
                            <th style="width: 65px;">@lang('Time')</th>
                            <th>@lang('Header')</th>
                            <th class="text-end" style="width: 75px;">@lang('Actions')</th>
                        </tr>
                    </thead>
                    <tbody>
        ...
        <form id="delete-log-form" action="{{ route('log-viewer::logs.delete') }}" method="POST">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>@lang('Are you sure you want to') <span class="badge badge-level-error">@lang('Delete')</span> @lang('This File')
                        <span class="badge badge-level-info">{{ $log->date }}</span> ?
                    </p>
                </div>
                <div class="modal-footer">
                    <button type="submit" class="btn btn-sm btn-danger" data-loading-text="@lang('Loading')&hellip;">
                        @lang('Delete')
                    </button>
